  ...
  return (
    <div className={cn('border-line bg-card shadow-tarjeta rounded-lg border p-4', className)}>
      ...
      <dl className="mt-3 grid grid-cols-3 gap-3">
        <div>
          <dt className="text-faint text-[11px] font-medium tracking-wide uppercase">
            Receta
          </dt>
          <dd className="mt-0.5">
        ...
        <div>
          ...
          <dd className="mt-0.5">
            <Cifra valor={num(objetivo)} unidad={unidad} tono="plc" tamano="sm" />
          </dd>
        </div>
        <div>
          <dt className="text-faint text-[11px] font-medium tracking-wide uppercase">
      ...
      {recetaMalCargada ? (
        <p className="text-warn-text bg-warn-soft border-warn/30 mt-3 rounded border px-2 py-1.5 text-xs">

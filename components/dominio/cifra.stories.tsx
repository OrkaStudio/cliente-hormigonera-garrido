...
export const Tonos: Story = {
  render: () => (
    <div className="flex flex-wrap items-baseline gap-6">
      ...
      <Cifra valor="+9 kg" tono="warn" tamano="lg" />
      <Cifra valor="+34 kg" tono="danger" tamano="lg" />
      <Cifra valor="320 kg" tono="plc" tamano="lg" />
    </div>
  ),
};
...
export const PorQueTabulares: Story = {
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-8">
      <div>
        <p className="text-faint mb-2 text-xs font-semibold uppercase">Con .num</p>
      ...
      <div>
        <p className="text-faint mb-2 text-xs font-semibold uppercase">Sin .num</p>

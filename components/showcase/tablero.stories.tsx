...
function Tablero() {
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <header className="border-hormigon-300 bg-card border-b">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <div className="flex items-baseline gap-2">
            <span className="text-marca-rojo text-lg font-black tracking-tight">HORMIMONTE</span>
            <span className="text-hormigon-400 text-xs">Planta Monte · Ruta 3 y 41</span>
          </div>
          <nav className="text-hormigon-500 hidden gap-5 text-sm md:flex">
            <span className="text-hormigon-900 border-hormigon-900 border-b-2 pb-0.5 font-medium">
              Inicio
            </span>
            <span>Cargas</span>
            <span>Ventas</span>
      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="border-hormigon-300 bg-card shadow-tarjeta self-start overflow-hidden rounded-lg border lg:col-span-2">
            <div className="border-hormigon-200 flex flex-wrap items-center justify-between gap-3 border-b px-4 py-3">
            ...
            <Table>
              ...
              <TableBody>
                {visibles.map((c) => (
                  <TableRow key={c.hora}>
                    <TableCell className="num text-hormigon-500">{c.hora}</TableCell>
                    <TableCell>
                      <span className="font-medium">{c.cliente}</span>
                      <span className="text-hormigon-400 ml-2 text-xs">{c.receta}</span>
                    </TableCell>
